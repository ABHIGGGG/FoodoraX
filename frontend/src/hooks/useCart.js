...
//hook and provider to manage cart state wrapped around the app so that any component can access cart state using useCart
...
export default function CartProvider({ children }) {
  ...
  //update total price and count whenever cart items change and save to local storage
  useEffect(() => {
